...
export const popupInputTextName = document.querySelector('.popup__input_text_name');
export const popupInputTextDescription = document.querySelector('.popup__input_text_description');
